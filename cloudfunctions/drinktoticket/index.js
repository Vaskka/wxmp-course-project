...
exports.main = async (event, context) => {
  ...
  let resp = await got(GATEWAY + '/drinkpoint/get/' + wxContext.OPENID, {
    method: 'GET',
    json: true
  });
  ...
  // 扣除奶茶积分
  let ticket = null;
  let url = GATEWAY + '/drinkpoint/change/' + wxContext.OPENID + '/' + sid + '/' + (curr_num - cost);
  ...
  let pro_ticket = got(GATEWAY + '/drinkticket/create', {
    method: 'POST',
    json: true,
    body: {
