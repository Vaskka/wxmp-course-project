...
exports.main = async (event, context) => {
  ...
  // 获取全部shop信息
  let resp = await got(GATEWAY + '/shop/all', {
    method: 'GET',
    headers: {
      accept: "*/*"
    },
  ...
  // 获取全部shop信息
  resp = await got(GATEWAY + '/item/all', {
    method: 'GET',
    headers: {
      accept: "*/*"
    },
  ...
  // 奶茶积分
  let pro_resp_point = got(GATEWAY + '/drinkpoint/get/' + wxContext.OPENID, {
    method: 'GET',
    headers: {
      accept: "*/*"
    },
  ...
  // 查找奶茶券数据
  let ticket_list = [];
  let pro_resp_ticket = got(GATEWAY + '/drinkticket/get/openid/' + wxContext.OPENID, {
    method: 'GET',
    headers: {
      accept: "*/*"
    },
